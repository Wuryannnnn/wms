    ...
    <el-card>
      <el-form :model="queryParams" ref="queryRef" :inline="true" label-width="68px">
        ...
        <el-form-item label="原料名称" prop="itemName">
          <el-input v-model="queryParams.itemName" clearable placeholder="请输入原料名称"></el-input>
        </el-form-item>
        <el-form-item label="原料编号" prop="itemCode">
          <el-input v-model="queryParams.itemCode" clearable placeholder="请输入原料编号"></el-input>
        </el-form-item>
