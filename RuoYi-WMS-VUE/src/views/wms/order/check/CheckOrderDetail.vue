<template>
  <el-drawer :model-value="show" :title="'盘库单【' + orderNo + '】的原料明细'" @close="handleCancelClick" :size="size" :close-on-click-modal="false"
             append-to-body>
    <div class="flex-space-between">
      <div></div>
      <el-checkbox v-model="queryParams.haveProfitAndLoss" label="只查看有盈亏数的" @change="handleQuery"/>
    </div>
    <el-table :data="list" border empty-text="暂无原料明细" v-loading="loading" ref="inventorySelectFormRef"
