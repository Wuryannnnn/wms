  ...
  <div class="app-container">
      ...
      <el-form :model="queryParams" ref="queryRef" label-width="90px" :inline="true">
        <el-form-item class="col4" label="维度 " prop="itemId">
          <el-radio-group v-model="queryType" size="default" @change="handleSortTypeChange">
            ...
            <el-radio-button label="item">原料</el-radio-button>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item class="col4" label="原料名称" prop="itemName">
          <el-input v-model="queryParams.itemName" clearable placeholder="原料名称"></el-input>
        </el-form-item>
        <el-form-item class="col4" label="原料编号" prop="itemCode">
          <el-input v-model="queryParams.itemCode" clearable placeholder="原料编号"></el-input>
        </el-form-item>
    ...
    <el-card class="mt20">
      <div class="mb8 flex-space-between">
        ...
        <el-checkbox v-model="filterable" label="过滤掉库存为0的原料" size="large" @change="handleChangeFilterZero"/>
      </div>
      <el-table :data="inventoryList" border :span-method="spanMethod"
        ...
        <template v-if="queryType == 'warehouse'">
          ...
          <el-table-column label="原料信息" prop="warehouseIdAndItemId">
            <template #default="{ row }">
              <div>{{ row.item.itemName }}</div>
              <div v-if="row.item.itemCode">原料编号：{{ row.item.itemCode }}</div>
            </template>
          </el-table-column>
